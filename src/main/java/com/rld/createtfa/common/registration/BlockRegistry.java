...
import com.rld.createtfa.CreativeTabs;
import com.rld.createtfa.common.api.*;
import com.rld.createtfa.common.blocks.*;
...
import static com.rld.createtfa.common.api.CageLamps.*;
...
public class BlockRegistry {
	...
	private static void registerPlacards () {
		for (DyeColor color : DyeColor.values()) {
			if (color == DyeColor.WHITE) continue; //white is default
