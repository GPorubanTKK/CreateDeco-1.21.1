package com.rld.createdeco.common;

import com.rld.createdeco.BlockStateGenerator;
import com.rld.createdeco.CreateDecoMod;
import com.rld.createdeco.CreativeTabs;
import com.rld.createdeco.common.api.*;
import com.rld.createdeco.common.blocks.*;
...
import static com.rld.createdeco.common.api.CageLamps.*;
...
public class BlockRegistry {
	...
	public static void init() {
		...
		//registerShippingContainers(); //shipping containers are not currently functional
		registerDecals();
		registerPlacards();
	...
	public static final BlockEntry<ConnectedGlassPaneBlock> //TODO: FIX DATA GEN
	...
	private static void registerLadders (String metal, Function<String, Item> getter) {
		if (metal.contains("opper") || metal.contains("ndesite") || metal.contains("rass")) {
            CreateDecoMod.LOGGER.info("Skipping Ladder Reg for metal {}", metal);
            return;
        }
        CreateDecoMod.LOGGER.info("Registering Ladder for metal {}", metal);
