...
import com.rld.createtfa.common.blocks.CageLampBlock;
...
public class CageLamps {
  ...
  public static BlockBuilder<CageLampBlock, ?> build (
      CreateTFARegistrate reg, String name, DyeColor color, ResourceLocation cage, ResourceLocation lampOn, ResourceLocation lampOff
  ) {
    return reg.block(color.getName().toLowerCase(Locale.ROOT) + "_" + name.toLowerCase(Locale.ROOT).replaceAll(" ", "_") + "_lamp",
      ...
      .blockstate(BlockStateGenerator::cageLamp)
